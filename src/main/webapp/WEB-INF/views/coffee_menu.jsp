...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div id="fh5co-blog-section" class="fh5co-section-gray">
			...
			<div class="container">
				<div class="row">
				<c:forEach items="${coffee_menu}" var="coffee_menu">
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<a href="#"><img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/${coffee_menu.mImg}.jpg" alt=""></a>
								<div class="image-popup" href="#">
									<div class="prod-title">
									<h3><a href=""#>${coffee_menu.mName}</a><span class="comment"><a href="">${coffee_menu.mPrice}￦<i class="icon-bubble22"></i></a></span></h3>
									<p>1회 제공량(kcal) : ${coffee_menu.mSize}<br/>나트륨(mg) : ${coffee_menu.mNa}<br/>포화지방(g) : ${coffee_menu.mFat}<br/>당류(g) : ${coffee_menu.mSugar}<br/>단백질(g) : ${coffee_menu.mPro}<br/>카페인(mg) : ${coffee_menu.mCa}</p>
									<input type="button" value="PURCHASE" class="btn btn-primary" id="${coffee_menu.mName}" onclick="popup_purchase()"">
								</div>
							</div> 
						</div>
					</div>

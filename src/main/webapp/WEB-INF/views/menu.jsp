				...
				<div class="row">
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							...
							<a href="${pageContext.request.contextPath}/coffee_menu"><img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/coffee1.jpg" alt=""></a>
							</s:authorize>
							<s:authorize ifAnyGranted="ROLE_ADMIN">
							<a href="${pageContext.request.contextPath}/admin/a_coffee_menu"><img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/coffee1.jpg" alt=""></a>
							</s:authorize>
							<div class="image-popup" href="coffee_menu">
								<div class="prod-title">
									...
									<s:authorize ifNotGranted="ROLE_ADMIN">
									<a href="${pageContext.request.contextPath}/coffee_menu" class="btn btn-primary">Read More</a>
									</s:authorize>
									<s:authorize ifAnyGranted="ROLE_ADMIN">
									<a href="${pageContext.request.contextPath}/admin/a_coffee_menu" class="btn btn-primary">Read More</a>
									</s:authorize>
								</div>
							</div> 
						</div>
					...
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<s:authorize ifNotGranted="ROLE_ADMIN">
							<a href="${pageContext.request.contextPath}/drink_tea_menu"><img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/drink.jpg" alt=""></a>
							</s:authorize>
							<s:authorize ifAnyGranted="ROLE_ADMIN">
							<a href="${pageContext.request.contextPath}/admin/a_drink_tea_menu"><img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/drink.jpg" alt=""></a>
							</s:authorize>
							<div class="image-popup" href="drink_tea_menu">
								<div class="prod-title">
									...
									<s:authorize ifNotGranted="ROLE_ADMIN">
									<a href="${pageContext.request.contextPath}/drink_tea_menu" class="btn btn-primary">Read More</a>
									</s:authorize>
									<s:authorize ifAnyGranted="ROLE_ADMIN">
									<a href="${pageContext.request.contextPath}/admin/a_drink_tea_menu" class="btn btn-primary">Read More</a>
									</s:authorize>
								</div>
							</div> 
						</div>
					...
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<s:authorize ifNotGranted="ROLE_ADMIN">
							<a href="${pageContext.request.contextPath}/dessert_menu"><img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/desert.jpg" alt=""></a>
							</s:authorize>
							<s:authorize ifAnyGranted="ROLE_ADMIN">
							<a href="${pageContext.request.contextPath}/admin/a_dessert_menu"><img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/desert.jpg" alt=""></a>
							</s:authorize>
							<div class="image-popup" href="dessert_menu">
								<div class="prod-title">
									...
									<s:authorize ifNotGranted="ROLE_ADMIN">
									<a href="${pageContext.request.contextPath}/dessert_menu" class="btn btn-primary">Read More</a>
									</s:authorize>
									<s:authorize ifAnyGranted="ROLE_ADMIN">
									<a href="${pageContext.request.contextPath}/admin/a_dessert_menu" class="btn btn-primary">Read More</a>
									</s:authorize>
								</div>
							</div> 
						</div>

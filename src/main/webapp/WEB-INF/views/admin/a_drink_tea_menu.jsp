...
<script type="text/javascript">
	...
	function Enroll() { 
		window.open('${pageContext.request.contextPath}/reg/enroll', '', 'resizable=no, scrollbars=no, height=770, width=380, left='+ popupX + ', top='+ popupY + ', screenX='+ popupX + ', screenY= '+ popupY);
	}
		...
		<div id="fh5co-page">
			<div id="fh5co-header">
				...
				<div class="container">
					<div class="nav-header">
						...
						<h1 id="fh5co-logo">
							<a href="${pageContext.request.contextPath}/index"><span>EDELIA</span></a>
						</h1>
						<!-- START #fh5co-menu-wrap -->
						<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							<li><a href="${pageContext.request.contextPath}/index">Home</a></li>
							<li><a href="${pageContext.request.contextPath}/portfolio" class="fh5co-sub-ddown">Cafe
									Image</a></li>
							<li><a href="${pageContext.request.contextPath}/services" class="fh5co-sub-ddown">Coffee
									Story</a></li>
			...
			<div class="fh5co-hero fh5co-hero-2">
				...
				<div class="fh5co-cover fh5co-cover_2 text-center"
					...
					style="background-image: url(${pageContext.request.contextPath}/resources/images/work-3.jpg);">
			...
			<div id="fh5co-blog-section" class="fh5co-section-gray">
				<div class="container">
					<div class="row">
						<div
							...
							<p>
								Tea is a beverage from tea leaves. <br />Generally, a plant is
								called a tea drink.
							</p>
						</div>
					</div>
				...
				<div class="container">
					<div class="row">
						<c:forEach items="${a_drink_tea_menu}" var="a_drink_tea_menu">
							<div class="col-lg-4 col-md-4">
								<div class="fh5co-blog animate-box">
									<a href="${pageContext.request.contextPath}/reg/modify?mId=${a_drink_tea_menu.mId}"><img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/${a_drink_tea_menu.mImg}.jpg" alt=""></a>
									<div class="image-popup" href="#">
										<div class="prod-title">
											<h3>
												<a href=""#>${a_drink_tea_menu.mName}</a><span class="comment"><a
													href="">${a_drink_tea_menu.mPrice}￦<i class="icon-bubble22"></i></a></span>
											</h3>
											<p>
												1회 제공량(kcal) : ${a_drink_tea_menu.mSize}<br />나트륨(mg) : ${a_drink_tea_menu.mNa}<br />포화지방(g)
												: ${a_drink_tea_menu.mFat}<br />당류(g) : ${a_drink_tea_menu.mSugar}<br />단백질(g) :
												${a_drink_tea_menu.mPro}<br />카페인(mg) : ${a_drink_tea_menu.mCa}
											</p>
											<input type="button" value="DELETE" class="btn btn-primary"
												id="${a_drink_tea_menu.mName}">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-4 col-md-4">
							<div class="fh5co-blog animate-box">
								<a href="a_drink_tea_menu" onclick="Enroll()"><img

...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	function popup_purchase() { 
		window.open('${pageContext.request.contextPath}/purchase/purchasemenu', '', 'location=no, height=426, width=400, left='+ popupX + ', top='+ popupY + ', screenX='+ popupX + ', screenY= '+ popupY);
	}
	...
	<body>
		...
		<div id="fh5co-blog-section" class="fh5co-section-gray">
			...
			<div class="container">
				<div class="row">
				<c:forEach items="${a_coffee_menu}" var="a_coffee_menu">
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<a href="${pageContext.request.contextPath}/reg/modify?mId=${a_coffee_menu.mId}"><img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/${a_coffee_menu.mImg}.jpg" alt=""></a>
								<div class="image-popup" href="#">
									<div class="prod-title">
									<h3><a href=""#>${a_coffee_menu.mName}</a><span class="comment"><a href="">${a_coffee_menu.mPrice}￦<i class="icon-bubble22"></i></a></span></h3>
									<p>1회 제공량(kcal) : ${a_coffee_menu.mSize}<br/>나트륨(mg) : ${a_coffee_menu.mNa}<br/>포화지방(g) : ${a_coffee_menu.mFat}<br/>당류(g) : ${a_coffee_menu.mSugar}<br/>단백질(g) : ${a_coffee_menu.mPro}<br/>카페인(mg) : ${a_coffee_menu.mCa}</p>
									<input type="button" value="DELETE" class="btn btn-primary" id="${a_coffee_menu.mName}">
								</div>
							</div> 
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<a href="a_coffee_menu" onclick="Enroll()"><img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/add.png" alt=""></a>
								<div class="image-popup" href="#">
								</div>
							</div> 
						</div>

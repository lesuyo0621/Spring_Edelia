				...
				<div class="container">
					<div class="row">
						<div
							...
							<h3>dessert menu</h3>
							<p>Dessert or dessert is eaten with food after eating, and
								there are many kinds.</p>
						</div>
					</div>
				</div>
				<div class="container">
					<div class="row">
						<c:forEach items="${a_dessert_menu}" var="a_dessert_menu">
							<div class="col-lg-4 col-md-4">
								<div class="fh5co-blog animate-box">
									<a href="${pageContext.request.contextPath}/reg/modify?mId=${a_dessert_menu.mId}"><img class="img-responsive"
										src="${pageContext.request.contextPath}/resources/images/${a_dessert_menu.mImg}.jpg"
										alt=""></a>
									<div class="image-popup" href="#">
										<div class="prod-title">
											<h3>
												<a href=""#>${a_dessert_menu.mName}</a><span class="comment"><a
													href="">${a_dessert_menu.mPrice}￦<i class="icon-bubble22"></i></a></span>
											</h3>
											<p>
												1회 제공량(kcal) : ${a_dessert_menu.mSize}<br />나트륨(mg) : ${a_dessert_menu.mNa}<br />포화지방(g)
												: ${a_dessert_menu.mFat}<br />당류(g) : ${a_dessert_menu.mSugar}<br />단백질(g) :
												${a_dessert_menu.mPro}<br />카페인(mg) : ${a_dessert_menu.mCa}
											</p>
											<input type="button" value="DELETE" class="btn btn-primary"	id="${a_dessert_menu.mName}">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-4 col-md-4">
							<div class="fh5co-blog animate-box">
								<a href="a_dessert_menu" onclick="Enroll()"><img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/add.png" alt=""></a>

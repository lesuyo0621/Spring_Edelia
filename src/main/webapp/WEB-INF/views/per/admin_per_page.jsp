					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<s:authorize ifAnyGranted="ROLE_ADMIN">
								<li class="active"><a href="${pageContext.request.contextPath}/per/admin_per_page">${pageContext.request.userPrincipal.name}님</a><li>
								</s:authorize>
			...
			<div class="container">
						...
						<figure>
							<center><div class="editable" style="overflow:auto;">
									<table class="type09">
										...
										<thead>
											<tr>
												<th scope="cols"><center>이름</center></th>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 animate-box">
						...
						<i class="icon-phone2"></i> TEL : 010 2285 5238
						</p>
					</div>
				</div>
			</div>

...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div id="fh5co-blog-section" class="fh5co-section-gray">
			...
			<div class="container">
				<div class="row">
					<c:forEach items="${dessert_menu}" var="dessert_menu">
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<a href="#"><img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/${dessert_menu.mImg}.jpg" alt=""></a>
								<div class="image-popup" href="#">
									<div class="prod-title">
									<h3><a href=""#>${dessert_menu.mName}</a><span class="comment"><a href="">${dessert_menu.mPrice}￦<i class="icon-bubble22"></i></a></span></h3>
									<p>1회 제공량(kcal) : ${dessert_menu.mSize}<br/>나트륨(mg) : ${dessert_menu.mNa}<br/>포화지방(g) : ${dessert_menu.mFat}<br/>당류(g) : ${dessert_menu.mSugar}<br/>단백질(g) : ${dessert_menu.mPro}<br/>카페인(mg) : ${dessert_menu.mCa}</p>
									<input type="button" value="PURCHASE" class="btn btn-primary" id="${dessert_menu.mName}" onclick="popup_purchase()"">
								</div>
							</div> 
						</div>
					</div>
